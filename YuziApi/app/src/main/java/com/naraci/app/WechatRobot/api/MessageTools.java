package com.naraci.app.WechatRobot.api;
...
import com.naraci.app.WechatRobot.utils.Config;
import com.naraci.app.WechatRobot.utils.MyHttpClient;
import com.naraci.app.WechatRobot.utils.enums.StorageLoginInfoEnum;
import com.naraci.app.WechatRobot.utils.enums.URLEnum;
import com.naraci.app.WechatRobot.utils.enums.VerifyFriendEnum;
...
public class MessageTools {
	 ...
	 * @return
	 */
	public static boolean sendPicMsgByNickName(String nickName, String filePath) throws JSONException {
		String toUserName = WechatTools.getUserNameByNickName(nickName);
		if (toUserName != null) {
	 ...
	 * @return
	 */
	public static boolean sendPicMsgByUserId(String userId, String filePath) throws JSONException {
	 ...
	 * @return
	 */
	private static boolean webWxSendMsgImg(String userId, String mediaId) throws JSONException {
	 ...
	 * @return
	 */
	public static boolean sendFileMsgByUserId(String userId, String filePath) throws JSONException {
	 ...
	 * @return
	 */
	public static boolean sendFileMsgByNickName(String nickName, String filePath) throws JSONException {
		String toUserName = WechatTools.getUserNameByNickName(nickName);
		if (toUserName != null) {
	 ...
	 * @return
	 */
	private static boolean webWxSendAppMsg(String userId, Map<String, String> data) throws JSONException {
